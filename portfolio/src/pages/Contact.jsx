        ...
        <div className="row mt-3 mb-5">
            ...
            <div className="col-lg-6">
                ...
                <div className="row mx-auto justify-content-center">
                    <a href="https://www.linkedin.com/in/matthew-lightfoot" style={styles.contactLink} className="btn btn-light mt-4 mx-3 col-4 d-flex justify-content-around align-items-center" role="button"><img src="./assets/linkedin.svg" alt="" />LinkedIn</a>
